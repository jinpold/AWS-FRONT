...
const Login: NextPage = () => {
    ...
    const handleSubmit = () => {
        ...
        return (
            <div
            className="flex justify-center content-center w-screen items-center h-screen bg-cover bg-center"
            style={{
              backgroundImage: "url('')"
            }}
          >
            <div className="flex rounded-lg shadow-lg border w-[70%] h-[60%] bg-white bg-opacity-75">
              <div
                className="hidden md:block lg:w-1/2 bg-cover bg-indigo-950"
                style={{
                  backgroundImage: "url('https://i.namu.wiki/i/kF4DbOVxjeMVm1A7GeQKsIhgaCM6VPXSwDbsryEwglLglapp4-QxwmguseIWNTZY3ztUhmi0mS989FjoEsVAkQ.webp')"
                }}
              ></div>
              <div className="w-full p-8 lg:w-1/2">
                ...
                <div className="mt-8">
                  <button className="bg-red-950 text-white font-bold py-2 px-4 w-full rounded hover:bg-pink-700"
